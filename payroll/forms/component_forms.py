...
from erpx_widgets.forms import erpxForm
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = erpxMultiSelectField(
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items():
            if isinstance(field.widget, forms.Select):
                field.widget.option_template_name = "erpx_widgets/select_option.html"
...
class GeneratePayslipForm(erpxForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    if apps.is_installed("leave"):
        ...
        def get_encashable_leaves(self, employee):
            LeaveType = get_erpx_model_class(app_label="leave", model="leavetype")
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_erpx_model_class(
