...
class Asset(erpxModel):
    ...
    objects = erpxCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(erpxModel):
    """
...
class AssetAssignment(erpxModel):
    """
    ...
    objects = erpxCompanyManager("asset_id__asset_lot_number_id__company_id")
