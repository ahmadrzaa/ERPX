"""
erpx_api/urls/attendance/urls.py
"""

from django.urls import path

from erpx_api.api_views.attendance.permission_views import AttendancePermissionCheck
from erpx_api.api_views.attendance.views import *
