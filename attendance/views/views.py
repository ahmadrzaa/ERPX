...
from erpx.erpx_settings import DYNAMIC_URL_PATTERNS, erpx_DATE_FORMATS
from erpx.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = erpx_DATE_FORMATS.get(date_format)
