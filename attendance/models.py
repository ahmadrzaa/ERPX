...
class AttendanceActivity(erpxModel):
    """
...
class AttendanceRequestFile(erpxModel):
    file = models.FileField(upload_to="attendance/request_files")


class AttendanceRequestComment(erpxModel):
    """
...
class AttendanceOverTime(erpxModel):
    """
...
class AttendanceLateComeEarlyOut(erpxModel):
    """
...
class AttendanceValidationCondition(erpxModel):
    """
...
class AttendanceGeneralSetting(erpxModel):
    """
...
if apps.is_installed("leave") and apps.is_installed("payroll"):
    ...
    class PenaltyAccount(erpxModel):
        """
    ...
    def create_initial_stage(sender, instance, created, **kwargs):
        ...
        if created:
            ...
            if penalty_amount:
                Deduction = get_erpx_model_class(
...
class WorkRecords(models.Model):
    ...
    def title_message(self):
        ...
        if title_message == "Absent":
            if apps.is_installed("leave"):
                LeaveRequest = get_erpx_model_class(
