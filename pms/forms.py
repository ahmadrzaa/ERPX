...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = erpxMultiSelectField(
        ...
        self.fields["managers"] = erpxMultiSelectField(
            queryset=Employee.objects.all(),
            widget=erpxMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # erpx multi select filter for employee
        self.fields["subordinate_id"] = erpxMultiSelectField(
            queryset=Employee.objects.all(),
            widget=erpxMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class MeetingsForm(BaseForm):
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], erpxMultiSelectField):
