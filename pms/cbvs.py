...
class BonusPointSettingSectionView(views.erpxSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.erpxNavView):
    """
...
class BonusPointSettingFormView(views.erpxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.erpxListView):
    """
...
class EmployeeBonusPointSectionView(views.erpxSectionView):
    """
...
class EmployeeBonusPointNavView(views.erpxNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.erpxFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.erpxListView):
    """
    BnusPoint list view
    """
