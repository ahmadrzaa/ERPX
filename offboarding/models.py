...
class OffboardingStage(erpxModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(erpxModel):
    """
...
class OffboardingEmployee(erpxModel):
    """
...
class ResignationLetter(erpxModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_erpx_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(erpxModel):
    """
...
class OffboardingNote(erpxModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(erpxModel):
    """
