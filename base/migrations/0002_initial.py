...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='holidays',
            name='company_id',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='base.company', verbose_name='Company'),
        ),
        migrations.AddField(
            model_name='holidays',
            name='created_by',
        ...
        migrations.AddField(
            model_name='historicalworktyperequest',
            name='history_tags',
            field=models.ManyToManyField(to='erpx_audit.audittag'),
        ),
        migrations.AddField(
            model_name='historicalworktyperequest',
            name='history_user',
