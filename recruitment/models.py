...
class SurveyTemplate(erpxModel):
    """
...
class Stage(erpxModel):
    ...
    objects = erpxCompanyManager(related_company_field="recruitment_id__company_id")
...
from erpx.signals import pre_bulk_update


class RejectReason(erpxModel):
    """
    RejectReason
    """
...
class RejectedCandidate(erpxModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(erpxModel):
    """
    ...
    objects = erpxCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(erpxModel):
    """
...
class RecruitmentSurveyAnswer(erpxModel):
    """
...
class RecruitmentMailTemplate(erpxModel):
...
class SkillZoneCandidate(erpxModel):
    """
...
class CandidateRating(erpxModel):
...
class RecruitmentGeneralSetting(erpxModel):
    """
...
class InterviewSchedule(erpxModel):
    """
