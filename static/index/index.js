...
$(document).ready(function() {
  ...
  //  $('#id_basic_salary,#id_wage').attr("readonly", "readonly");


 $('#toggleAboutBtn').click(function () {
        $('#aboutContent').slideToggle(300);
         $('#aboutContent').toggleClass("active_tab"); 
        // Change button text based on state
        if ($('#aboutContent').hasClass('active_tab')) {
            $('#toggleAboutBtn').text('Show Less');
        } else {
            $('#toggleAboutBtn').text('Learn More');
        }
    });
