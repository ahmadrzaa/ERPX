...
from base.models import erpxMailTemplate
...
class MailAutomation(erpxModel):
    """
    MailAutoMation
    """
    ...
    mail_template = models.ForeignKey(erpxMailTemplate, on_delete=models.CASCADE)
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "erpx_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )
    ...
    def conditions(self):
        return render_template(
            "erpx_automations/conditions.html", {"instance": self}
        )
