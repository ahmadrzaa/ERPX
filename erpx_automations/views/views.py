"""
erpx_automation/views/views.py
"""
...
from erpx_automations.methods.methods import generate_choices
from erpx_automations.methods.serialize import serialize_form
...
@login_required
@permission_required("erpx_automation")
