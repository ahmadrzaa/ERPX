"""
erpx_automations/views/cbvs.py
"""
...
from erpx.decorators import login_required, permission_required
from erpx_automations import models
from erpx_automations.filters import AutomationFilter
from erpx_automations.forms import AutomationForm
from erpx_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("erpx_automation.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.erpxSectionView):
    """
    ...
    template_name = "erpx_automations/section_view.html"
...
class AutomationNavView(views.erpxNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("erpx_automation.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.erpxFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "erpx_automations/automation_form.html"
...
class AutomationListView(views.erpxListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.erpxDetailedView):
    """
