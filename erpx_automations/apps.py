...
from erpx_automations.signals import start_automation


class erpxAutomationConfig(AppConfig):
    default_auto_field = "django.db.models.BigAutoField"
    name = "erpx_automations"

    def ready(self) -> None:
        ready = super().ready()
        try:

            from base.templatetags.erpxfilters import app_installed
            from employee.models import Employee
            from erpx_automations.methods.methods import get_related_models
            from erpx_automations.models import MODEL_CHOICES
