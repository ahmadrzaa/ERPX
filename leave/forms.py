"""
This module provides erpx ModelForms for creating and managing leave-related data,
...
from erpx_widgets.forms import erpxForm, erpxModelForm
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = erpxMultiSelectField(
...
class LeaveRequestCreationForm(ModelForm):
    ...
    def as_p(self, *args, **kwargs):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("erpx_form.html", context)
        return table_html
...
class LeaveOneAssignForm(erpxModelForm):
    """
    ...
    Attributes:
        - employee_id: A erpxMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(erpxForm):
    """
    Form for Payslip
    """
