...
class AvailableLeave(erpxModel):
...
class LeaverequestComment(erpxModel):
    """
...
class LeaveAllocationRequest(erpxModel):
    leave_type_id = models.ForeignKey(
...
class LeaveallocationrequestComment(erpxModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(erpxModel):
        leave_type_id = models.ForeignKey(
            LeaveType, on_delete=models.PROTECT, verbose_name="Leave type"
        )
        employee_id = models.ForeignKey(
...
class LeaveGeneralSetting(erpxModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(erpxModel):
        """
...
class EmployeePastLeaveRestrict(erpxModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        def leaverequest_pre_save(sender, instance, **_kwargs):
            ...
            """
            WorkRecords = get_erpx_model_class(
