...
from erpx_views.cbv_methods import get_short_uuid, login_required
from erpx_views.forms import SavedFilterForm
from erpx_views.generic.cbv.views import erpxFormView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.erpxModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(erpxFormView):
    """
    SavedFilter
    """
