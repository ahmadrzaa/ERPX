...
class OnboardingStage(erpxModel):
    """
    ...
    objects = erpxCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(erpxModel):
    """
    ...
    objects = erpxCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(erpxModel):
    """
    ...
    objects = erpxCompanyManager("candidate_id__recruitment_id__company_id")
...
class OnboardingPortal(erpxModel):
    """
