...
from base.models import erpxMailTemplate, JobPosition
...
from erpx.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = erpxMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        erpxMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
