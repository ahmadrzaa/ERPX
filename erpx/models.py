...
This module defines the abstract base model `erpxModel` for the erpx HRMS project.
The `erpxModel` provides common fields and functionalities for other models within
...
class erpxModel(models.Model):
    ...
    erpx_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for erpxModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(erpxModel, self).save(*args, **kwargs)
...
auditlog.register(erpxModel, serialize_data=True)
