...
This module is used to register erpx addons
"""

from erpx import settings
from erpx.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("erpx_audit")
INSTALLED_APPS.append("erpx_widgets")
INSTALLED_APPS.append("erpx_crumbs")
INSTALLED_APPS.append("erpx_documents")
INSTALLED_APPS.append("haystack")
INSTALLED_APPS.append("erpx_views")
INSTALLED_APPS.append("erpx_automations")
